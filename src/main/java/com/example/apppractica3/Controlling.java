...
public class Controlling extends Activity {
    ...
    String izquierda = "6";//Izquierda
    String atras = "5";//Atras
    String automatico = "4";//Automatico
    String limpiar = "3";//Limpiar
    String rutas = "2";//Pantalla de limpiar rutas


    private ProgressDialog progressDialog;
    Button btnOn,btnOff, btnIzquierda, btnAbajo, btnRuta, btnAutomatico, btnLimpieza;
...
// TODO Auto-generated method stub
                try {
                    mBTSocket.getOutputStream().write(izquierda.getBytes());
...
// TODO Auto-generated method stub
                try {
                    mBTSocket.getOutputStream().write(atras.getBytes());
...
// TODO Auto-generated method stub
                try {
                    mBTSocket.getOutputStream().write(rutas.getBytes());
...
// TODO Auto-generated method stub
                try {
                    mBTSocket.getOutputStream().write(automatico.getBytes());
...
// TODO Auto-generated method stub
                try {
                    mBTSocket.getOutputStream().write(limpiar.getBytes());
